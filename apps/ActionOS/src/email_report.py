...
def build_web_html(
    ...
    js = (
        ...
        "document.getElementById('schedule-confirm').textContent='Schedule '+n+' block'+(n>1?'s':'');"
        "});});"
        ...
        ".then(function(d){"
        "if(d.ok){"
        "btn.textContent='\\u2713 '+d.events_created+' block'+(d.events_created>1?'s':'')+' scheduled!';"
    ...
    css = (
        ...
        "padding:12px 10px;min-height:44px;border-radius:8px;border:1px solid var(--border-h);"
        ...
        "#schedule-cancel{width:100%;font-family:inherit;font-size:14px;font-weight:600;"
        "min-height:44px;padding:10px;border-radius:8px;border:none;cursor:pointer;"
