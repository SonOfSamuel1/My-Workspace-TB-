...
def build_home_html(
    ...
    return (
        ...
        ".gp-card-title{font-size:14px;font-weight:400;color:var(--text-1);line-height:1.5;margin-bottom:8px;}"
        ...
        ".gp-activity-title{font-size:14px;font-weight:400;color:var(--text-1);line-height:1.4;margin-bottom:8px;}"
