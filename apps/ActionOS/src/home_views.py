...
def _build_task_card(
    ...
    due_date_input = (
        f"<div class=\"date-pill\" onclick=\"event.stopPropagation();this.querySelector('input').showPicker?this.querySelector('input').showPicker():this.querySelector('input').focus()\">"
...
def _build_calendar_card(
    ...
    _cal_labels = {
        ...
        "love_brittany": "Love Brittany", "love_children": "Love Children",
    }
    _cal_colors = {
        "family": "#818cf8", "medical": "#22c55e", "birthdays": "#eab308",
        "love_brittany": "#a78bfa", "love_children": "#a78bfa",
    }
