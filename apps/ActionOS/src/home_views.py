...
def build_godpower_view_html(function_url: str, godpower_state: dict = None) -> str:
    ...
    return (
        ...
        "min-height:44px;background:rgba(56,189,248,0.10);color:#38bdf8;border:1px solid rgba(56,189,248,0.25);cursor:pointer;"
        "display:inline-flex;align-items:center;gap:5px;}"
        ".toggl-btn{font-family:inherit;font-size:12px;font-weight:600;padding:5px 14px;border-radius:8px;"
        "min-height:44px;background:var(--warn-bg);color:var(--warn);border:1px solid var(--warn-b);cursor:pointer;}"
