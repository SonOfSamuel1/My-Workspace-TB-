...
def build_home_html(
    ...
    return (
        ...
        "padding:5px 14px;min-height:36px;border-radius:8px;"
        "background:var(--ok-bg);color:var(--ok);border:1px solid var(--ok-b);"
        ...
        ".schedule-btn:hover{background:rgba(56,189,248,0.20);}"
        ...
        "background:rgba(56,189,248,0.10);color:#38bdf8;border:1px solid rgba(56,189,248,0.25);"
        "cursor:pointer;transition:all .15s;}"
        ".schedule-prep-btn:hover{background:rgba(56,189,248,0.20);}"
        # Skip Inbox button
        ...
        ".assign-cc-btn:hover{background:var(--accent-b);}"
        # Schedule button (overrides earlier definition)
        ".schedule-btn{font-family:inherit;font-size:12px;font-weight:600;"
        "padding:5px 14px;min-height:36px;border-radius:8px;"
        "background:rgba(56,189,248,0.10);color:#38bdf8;border:1px solid rgba(56,189,248,0.25);cursor:pointer;"
        ...
        ".toggl-btn:hover{background:var(--warn-b);}"
...
def build_godpower_view_html(function_url: str, godpower_state: dict = None) -> str:
    ...
    return (
        ...
        "min-height:36px;background:var(--ok-bg);color:var(--ok);border:1px solid var(--ok-b);cursor:pointer;}"
        ".schedule-btn{font-family:inherit;font-size:12px;font-weight:600;padding:5px 14px;border-radius:8px;"
        "min-height:36px;background:rgba(56,189,248,0.10);color:#38bdf8;border:1px solid rgba(56,189,248,0.25);cursor:pointer;"
        "display:inline-flex;align-items:center;gap:5px;}"
        ".toggl-btn{font-family:inherit;font-size:12px;font-weight:600;padding:5px 14px;border-radius:8px;"
        "min-height:36px;background:var(--warn-bg);color:var(--warn);border:1px solid var(--warn-b);cursor:pointer;}"
