...
description:
  Perform cross-artifact consistency analysis across spec.md, plan.md, and
  tasks.md. Use after task generation to identify gaps, duplications, and
...
implementation. This command MUST run only after `/speckit.tasks` has
